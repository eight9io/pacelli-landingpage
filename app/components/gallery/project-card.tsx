        ...
        {item.cover.map((img, index) => (
          ...
          >
            <img
              ...
              alt="Carousel"
            />
            <div className="bg-gradient-to-t from-gray-800 to-transparent absolute h-4/5 w-full bottom-0"></div>
              ...
              {item.subtitles && item.subtitles[index] ? (
                <div
                  className={clsx(
                    ...
                    'text-white whitespace-pre-wrap line-clamp-3 max-h-[72px] md:line-clamp-5 align-text-bottom	self-end',
                  )}
                >
